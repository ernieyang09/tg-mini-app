...
export function loadBuy(slice: Slice) {
  let sc_0 = slice
  if (sc_0.loadUint(32) !== 3802013228) {
    throw Error("Invalid prefix")
  }
...
export function loadCancel(slice: Slice) {
  let sc_0 = slice
  if (sc_0.loadUint(32) !== 1561823489) {
    throw Error("Invalid prefix")
  }
  let _amount = sc_0.loadUintBig(32)
  let _price = sc_0.loadIntBig(256)
...
export function loadFee(slice: Slice) {
  let sc_0 = slice
  if (sc_0.loadUint(32) !== 3455044923) {
    throw Error("Invalid prefix")
  }
...
const Inshrimption_types: ABIType[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      {
        name: "price",
        type: { kind: "simple", type: "int", optional: false, format: 256 },
      },
      {
        name: "expiry",
        type: { kind: "simple", type: "int", optional: false, format: 256 },
...
export class Inshrimption implements Contract {
  ...
  async send(
    ...
    message: Buy | Cancel | Fee | "Withdraw" | string | null | Deploy
  ) {
